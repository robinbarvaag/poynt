  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8">
      <div className="w-full max-w-2xl">
        ...
        <Card className="p-8">
          {/* Re-mount på stegbytte gir en rolig inntoning av neste steg i
              stedet for et hardt klipp. Engangsflyt — litt bevegelse er lov. */}
          <div
            key={currentStep}
              ...
              <div className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {features.map((feature, index) => (
                    <Card
                      key={feature.title}
                      className="motion-safe:fade-in-0 motion-safe:slide-in-from-bottom-2 motion-safe:fill-mode-both motion-safe:animate-in bg-muted p-5 transition-colors motion-safe:duration-300 motion-safe:ease-soft hover:bg-muted/70"
            ...
            {currentStep === "complete" && (
              <div className="space-y-6 text-center">
                <div className="flex justify-center">
                  <div className="animate-success-pop flex size-16 items-center justify-center rounded-full bg-primary/10">
