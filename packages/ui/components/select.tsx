...
import { type ControlSize, controlSizeVariants } from "./form/control-size";
...
function SelectTrigger({
  ...
  // Deler høyde-skala med Input/Button via `controlSizeVariants`.
  size?: ControlSize;
}) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        controlSizeVariants({ sizeVariant: size }),
